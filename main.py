...
class Human:
    ...
    def shopping(self, manage):
        ...
        if manage == "fluel":
            ...
            self.money -= 50
            self.home.food += 50
        elif manage == "delicacy!":
            print("I'm happy! Delicacy!")
            self.money -= 15
            self.gladness += 10
            self.satiety += 2
    ...
    def live(self, day):
        ...
        if self.job is None:
            self.get_job()
            print(f"I don't have job, I'm going to ger a job {self.job.job}"
